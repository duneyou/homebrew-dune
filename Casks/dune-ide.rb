...
cask "dune-ide" do
  ...
  on_arm do
    sha256 "0146c7226cf8975f4f2300c5288b7cd36ef5f7b1002b39febe3ca53648605e4d"
    url "https://github.com/duneyou/dune/releases/download/v1.5.12/Dune-tish-darwin-arm64.dmg"
  end
